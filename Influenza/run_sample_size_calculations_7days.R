...
load('Rout/model_fits_job_2.RData') #using parameters from 7 days follow-up
...
save(sim_settings, file = 'Rout/sim_settings_7days.RData')
...
f_name = paste0('sims_out_7days/sim_out_7days_',i,'.csv')
print(f_name)
