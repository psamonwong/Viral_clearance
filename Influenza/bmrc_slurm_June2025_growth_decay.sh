...
Rscript /well/moru-batty/users/lcd199/Viral_clearance/Influenza/run_sample_size_calculations_June2025_growth_decay.R ${SLURM_ARRAY_TASK_ID} --no-save --no-restore
echo "finished="`date`
exit 0