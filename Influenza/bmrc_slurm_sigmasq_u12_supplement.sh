...
Rscript /well/moru-batty/users/lcd199/Viral_clearance/Influenza/run_sample_size_calculations_sigmasq_u12_supplement.R ${SLURM_ARRAY_TASK_ID} --no-save --no-restore
echo "finished="`date`
exit 0