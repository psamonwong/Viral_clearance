...
save(sim_settings, file = 'Rout/sim_settings_sigmasq_u12_supplement.RData')
...
f_name = paste0('sims_out_sigmasq_u12_supplement/sim_out_sigmasq_u12_supplement',i,'.csv')
print(f_name)
