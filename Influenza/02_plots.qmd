...
G_pred <- annotate_figure(
  ggarrange(G1, G2, G3, common.legend = T, legend = "bottom", ncol = 3),
  left = text_grob("Viral densities (log10 genomes/mL)", rot = 90, vjust = 1, size = 13,
                   face = 'bold'),
  bottom = text_grob("Time since randomisation (days)", size = 13, face = 'bold'),
  top = text_grob("A) Predicted clearance kinetics", size = 16,
                  hjust = 1.45)
...
png(plot_name, width = 10, height = 6, units = 'in', res = 350)
print(G_pred)
dev.off()  
}
